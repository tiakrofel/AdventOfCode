...
let _ =
  ...
  and izpisi_datoteko ime_datoteke vsebina =
      ...
      close_out chan
  in
  let vsebina_datoteke = preberi_datoteko "vhodi/day_0.in" in
  let odgovor1 = naloga1 vsebina_datoteke
  and odgovor2 = naloga2 vsebina_datoteke
  in
  izpisi_datoteko "izhodi/day_0_1.out" (string_of_int odgovor1);
  izpisi_datoteko "izhodi/day_0_2.out" (string_of_int odgovor2)